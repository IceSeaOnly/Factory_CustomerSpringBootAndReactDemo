...
public abstract class BaseBean extends MapUtils {
    ...
    public void Assert(boolean expression, ErrorCode code) {
        if (!expression) {
            throw new SystemException(code);
        }
    }

    public void AssertNotNull(Object obj, ErrorCode code) {
        if (obj == null) {
            throw new SystemException(code);
        }
    }

    public void AssertNotEmpty(String obj, ErrorCode code) {
